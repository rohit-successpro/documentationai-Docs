...
<Columns cols="2">
  <Card title="Project Management Tools" href="#project-management-tools" icon="calendar" horizontal="false" target="_self">
    Plan, track, and deliver projects with real-time dashboards and automated workflows.
  </Card>

  <Card title="People Utilization Tracking" href="#people-utilization-tracking" icon="users" horizontal="false" target="_self">
    Monitor team capacity, skills, and allocation to maximize resource efficiency.
  </Card>

  <Card title="Financial Forecasting" href="#financial-forecasting" icon="trending-up" horizontal="false" target="_self">
    Predict revenue, costs, and margins with AI-powered models and scenario planning.
  </Card>

  <Card title="AI-Driven Insights" href="#ai-driven-insights" icon="zap" horizontal="false" target="_self">
